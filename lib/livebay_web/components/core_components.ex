defmodule LivebayWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LivebayWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LivebayWeb.Gettext, "errors", msg, opts)
    end
  end
